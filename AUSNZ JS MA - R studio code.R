...
#
#   Page, M. J., Higgins, J. P. T., & Sterne, J. A. C. (2019). Chapter 13: Assessing risk of bias due to missing results in a synthesis. In 
#               J. P. T. Higgins, J. Thomas, J. Chandler, M. Cumpston, T. Li, M. J. Page, & V. A. Welch (Eds.), Cochrane handbook for systematic 
#               reviews of interventions (2nd ed., pp. 349-374). Wiley-Blackwell. https://doi.org/10.1002/9781119536604 
#
...
# Note: the mean_recid_rma_glmm_CMEL funnel plot has not been tested for asymmetry due to the small sample of effect sizes (see Page, Higgins, and Stern, 2019, p. 365)
